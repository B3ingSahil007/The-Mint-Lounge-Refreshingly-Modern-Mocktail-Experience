...
import underImage from '../assets/images/under-img.jpg'
...
const Art = () => {
  ...
  useGSAP(() => {
    ...
    const maskTimeline = gsap.timeline({ scrollTrigger: { trigger: '#art', start, end: 'bottom center', scrub: '1.5', pin: true } })
